...
public class PrinterService {
   ...
   public void printQRCode(String value) throws QRCodeException, IOException {
   ...
   public void setTextSizeNormal() throws IOException {
      setTextSize(1,1);
   }

   public void setTextSize2H() throws IOException {
      setTextSize(1,2);
   }

   public void setTextSize2W() throws IOException {
      setTextSize(2,1);
   }

   public void setText4Square() throws IOException {
      setTextSize(2,2);
   }

   private void setTextSize(int width, int height) throws IOException {
      if (height == 2 && width == 2) {
         write(TXT_NORMAL);
         write(TXT_4SQUARE);
      }else if(height == 2) {
   ...
   public void setTextTypeBold() throws IOException {
      setTextType("B");
   }

   public void setTextTypeUnderline() throws IOException {
      setTextType("U");
   }

   public void setTextType2Underline() throws IOException {
      setTextType("U2");
   }

   public void setTextTypeBoldUnderline() throws IOException {
      setTextType("BU");
   }

   public void setTextTypeBold2Underline() throws IOException {
      setTextType("BU2");
   }

   public void setTextTypeNormal() throws IOException {
      setTextType("NORMAL");
   }

   private void setTextType(String type) throws IOException {
   ...
   public void setTextFontA() throws IOException {
      setTextFont("A");
   }

   public void setTextFontB() throws IOException {
      setTextFont("B");
   }
   ...
   public void setTextAlignCenter() throws IOException {
      setTextAlign("CENTER");
   }

   public void setTextAlignRight() throws IOException {
      setTextAlign("RIGHT");
   }

   public void setTextAlignLeft() throws IOException {
      setTextAlign("LEFT");
   }

   private void setTextAlign(String align) throws IOException {
   ...
   public void setTextProperties(String align, String font, String type, int width, int height, int density) throws IOException {
      setTextAlign(align);
      setTextFont(font);
      setTextType(type);
